...
| File                               | Changes                                                                                                                                                                                                                                          |
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `src/app.css`                      | Darken `--color-brand` to `primary-600` (#e03a12, ~5.2:1 on white) and `--color-brand-hover` to `primary-700` (#ba2d0e). Darken `--color-muted` to `neutral-600` (#56564f, ~7.1:1). Add `.skip-link` styles (visually hidden, visible on focus). |
